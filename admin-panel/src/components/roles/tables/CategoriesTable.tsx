      ...
      columns={[
        ...
        { key: 'actions', title: 'عملیات', sortable: false, render: (c: any) => (
          <div className="flex items-center space-x-2 space-x-reverse">
            <Button variant="ghost" size="sm" onClick={() => onEdit(c)} title="ویرایش" className="text-indigo-600 hover:text-indigo-800">
              <PencilIcon className="h-4 w-4" />
            </Button>
            <Button variant="ghost" size="sm" onClick={() => onDelete(c.id)} title="حذف" className="text-red-600 hover:text-red-900">
